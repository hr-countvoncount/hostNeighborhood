...
const csvWriter = createCsvWriter({
	...
	header: [
		...
		{id: 'numberOfReferences', title: 'numberOfReferences'},
		{id: 'isVerified', title: 'isVerified'},
		{id: 'isSuper', title: 'isSuper'},
		{id: 'responseRate', title: 'responseRate'},
		{id: 'avatar', title: 'avatar'},
		{id: 'responseTime', title: 'responseTime'},
		{id: 'languages', title: 'languages'},
		{id: 'email', title: 'email'},
		{id: 'phoneNum', title: 'phoneNum'},
		{id: 'commuteTimeAvg', title: 'commuteTimeAvg'},
		{id: 'commutePriceAvg', title: 'commutePriceAvg'},
		{id: 'localCurrency', title: 'localCurrency'},
		{id: 'neighborhoodDescr', title: 'neighborhoodDescr'},
		{id: 'policies', title: 'policies'},
		{id: 'isCanc', title: 'isCanc'},
		{id: 'cancelation', title: 'cancelation'},
		{id: 'locationsNearby', title: 'locationsNearby'}
	]
})
...
let recSeeder = () => {
  ...
  while (recSeeds.length < 1000) {
    recSeeds.push({
			...
			neighborhoodDescr: faker.lorem.paragraphs(),
			policies: policies.toString(),
			isCanc: faker.random.boolean(),
